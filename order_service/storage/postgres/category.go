...
func (b *categoryRepo) Create(c context.Context, req *order_service.CreateCategoryRequest) (string, error) {
	if req.ParentId != 0 {
		query := `
...
func (b *categoryRepo) Get(c context.Context, req *order_service.IdRequest) (resp *order_service.Category, err error) {
	query := `
		SELECT 
			"id",
			"title", 
	...
	category := order_service.Category{}
...
func (b *categoryRepo) GetList(c context.Context, req *order_service.ListCategoryRequest) (*order_service.ListCategoryResponse, error) {
	var (
		resp   order_service.ListCategoryResponse
		err    error
		filter string
	...
	for rows.Next() {
		var category order_service.Category
...
func (b *categoryRepo) Update(c context.Context, req *order_service.UpdateCategoryRequest) (string, error) {
...
func (b *categoryRepo) Delete(c context.Context, req *order_service.IdRequest) (resp string, err error) {
