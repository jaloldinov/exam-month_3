...
func (b *productRepo) Create(c context.Context, req *order_service.CreateProductRequest) (string, error) {
...
func (b *productRepo) Get(c context.Context, req *order_service.IdRequest) (resp *order_service.Product, err error) {
	query := `
		SELECT 
			"id",
			"title", 
...
func (b *productRepo) GetList(c context.Context, req *order_service.ListProductRequest) (*order_service.ListProductResponse, error) {
	var (
		resp   order_service.ListProductResponse
		err    error
		filter string
...
func (b *productRepo) Update(c context.Context, req *order_service.UpdateProductRequest) (string, error) {
...
func (b *productRepo) Delete(c context.Context, req *order_service.IdRequest) (resp string, err error) {
